...
I am interested in pushing the frontiers of Soft X-ray spectroscopy tools for the study of interfaces. As an Advanced Light Source Postdoctoral Fellow, I am working in the group of Moni Blum at the Lawrence Berkeley National Lab to develop the use of planar liquid sheets with X-ray Photoelectron Spectroscopy. This technique can selectively probe specific elements at various depths from the interface and is a powerful tool for understanding the spatial profile and number densities of various species in solution.

Additionally, I work with Craig Schwartz (UNLV) and Walter Drisdell (LBNL) to develop nonlinear soft X-ray tools, such as soft X-ray second harmonic generation. This technique combines the element specificity of X-ray Spectroscopy with the surface-sensitivity of nonlinear optics. Using X-ray Free Electron Lasers - unique accelerator facilities that produce extremely bright and coherent X-rays - we conduct experiments on liquids and clean energy materials, such as perovskite solar cells and Si-based solar cells.

**PhD work**

My PhD was aimed at developing a deep understanding of the behavior of ions and water at aqueous interfaces. This work was motivated by the recent discovery that certain ions have enhanced concentrations in the interfacial region, relative to their bulk concentration, and by the importance that surfaces play in driving much of the chemistry we observe in the natural world. Our goal was to develop a mechanistic understanding of **what drives ions to aqueous interfaces**. To do this, we measured thermodynamic properties of prototypical ions to different types of interfaces.

In order to properly study interfaces we used specialized tools: second-order nonlinear spectroscopy, which is a surface-selective spectroscopy. [Our group](http://www.cchem.berkeley.edu/rjsgrp/sfgshg.php) has developed multiple techniques for this:
...
## (10) [Paper: Entropy or Enthalpy? Second Harmonic Generation From Liquid Sheets Reveals Different Ion Adsorption Mechanisms for Air-water and Oil-water Interfaces](https://pubs.acs.org/doi/10.1021/jacs.5c09036)

![Abstract Graphic](abstract.png){style="text-align: center"} 

This work is the final project from my PhD - something I have been working to finish  over the last two years. This was a great collaborative effort with my friend DJ Hoffman, who is a staff scientist at LCLS in Stanford, CA. In this work, we combine free-flowing planar liquid sheets with Deep UV Second Harmonic Generation Spectroscopy. The micron-thick, layered free-flowing sheets enable the simultaneous measurement of ion adsorption to both the air-water and water-heptane interfaces, and permits the retrieval of valuable phase information that is normally not accessible with DUV-SHG. Specifically, we measured temperature-dependent Langmuir isotherms of the thiocyanate anion at both interfaces and disentangled the entropic and enthalpic contributions to the Gibbs free energy of adsorption. We show that anion adsorption to these two surfaces have opposite thermodynamic driving forces, with ions being stabilized at the air-water interface by a favorable enthalpy change, whereas ions are stabilized at the water-heptane interface by a favorable entropy change.

## (9) ALS Postdoctoral Fellowship Poster Session

In September, I completed the first year of my Postdoctoral Fellowship at the Advanced Light Source (ALS) at the Lawrence Berkeley National Lab. It has been an amazing experience to be fully immersed in cutting edge X-ray science - I encourage anybody interested to check out the [fellowship webpage](https://als.lbl.gov/about/career-opportunities/als-collaborative-postdoctoral-fellowship-program/). The ALS offers fellowships for both doctoral and postdoctoral students! Using Ambient Pressure X-ray Photoelectron Spectroscopy, combined with planar liquid jets, we have been studying the surface partitioning of ions to the air-water interface. In the upcoming second year of my fellowship, we are moving towards studying dynamic proceses, with a particular interest in how reactions rates differ between the bulk and surface of a liquid solution. Check out my poster below for some more information!

[Poster Presented at the ALS Fellowship Poster Session](ALS_Fellow_Poster_ShaneDevlin_Final.pdf){style="text-align: center"}
...
![Four subtopics relating to our review paper](TOC_graphic.png){style="text-align: center"}

## (7) Conference: Faraday Discussion - "Water at Interfaces" London, England
...
**Journal of the American Chemical Society - September 2023** ![MD snapshot showing carbonate agglomeration in solution](Carb.jpg){style="text-align: center"}
...
The news team at the Lawrence Berkeley National Lab did a story on our findings, which can be accessed [here](https://newscenter.lbl.gov/2023/12/04/an-unexpected-discovery-at-the-air-water-interface/?utm_source=LBNL&utm_campaign=fbd83ba523-EMAIL_CAMPAIGN_2023_12_04_05_11_COPY_01&utm_medium=email&utm_term=0_-b5595049ef-%5BLIST_EMAIL_ID%5D).
