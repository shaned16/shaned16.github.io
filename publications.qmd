...
In September, I completed the first year of my Postdoctoral Fellowship at the Advanced Light Source (ALS) at the Lawrence Berkeley National Lab. Using Ambient Pressure X-ray Photoelectron Spectroscopy, combined with planar liquid jets, we have been studying the surface partitioning of ions to the air-water interface. In the upcoming second year of my fellowship, we are moving towards studying dynamic proceses, with a particular interest in understanding how certain reaction rates differ between the bulk and surface of a liquid solution. Check out my poster below for some more information!
